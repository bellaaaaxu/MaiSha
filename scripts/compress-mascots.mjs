// 班底资产压缩：mascot-staging/final/<id>.png + 队长 canonical → public/mascots/<id>.webp
// 用法：node scripts/compress-mascots.mjs
//
...
const FINAL_DIR = 'mascot-staging/final';
const OUT_DIR = 'public/mascots';
const CAPTAIN = ['docs/brand/xiaorongbao-canonical.webp', `${OUT_DIR}/xiaorongbao.webp`];
const SIZE = 256;
const QUALITY = 85;
...
if (existsSync(CAPTAIN[0])) jobs.push(CAPTAIN);
